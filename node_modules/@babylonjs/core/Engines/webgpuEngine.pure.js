...
import { IsIntegerTextureFormat, IsUnsignedIntegerTextureType } from "../Materials/Textures/textureHelper.functions.js";
...
export class WebGPUEngine extends ThinWebGPUEngine {
    ...
    createPrefilteredCubeTexture(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true, buffer = null) {
        ...
        return this.createCubeTexture(rootUrl, scene, null, false, callback, onError, format, forcedExtension, createPolynomials, lodScale, lodOffset, null, undefined, false, buffer);
    }
    /**
            ...
            for (let i = 0; i < this._mrtAttachments.length; ++i) {
                ...
                if (gpuMRTWrapper && gpuMRTTexture) {
                    ...
                    colorAttachments.push({
                        ...
                        depthSlice,
                        clearValue: index !== 0 && mustClearColor ? (isRtInteger ? (isRtUnsignedInteger ? clearColorForIntegerRt : clearColorForSignedIntegerRt) : clearColor) : undefined,
