...
export class AnimationGroup {
    ...
    _start(loop, speedRatio, from, to, isAdditive, useVirtualTimeline) {
        ...
        for (let index = 0; index < this._targetedAnimations.length; index++) {
            const targetedAnimation = this._targetedAnimations[index];
            const animatable = this._scene.beginDirectAnimation(targetedAnimation.target, [targetedAnimation.animation], samplingFrom, samplingTo, this._usesVirtualSampling || loop, speedRatio, undefined, undefined, isAdditive !== undefined ? isAdditive : this._isAdditive);
    ...
    _sampleVirtualTimeline() {
        this._updateVirtualFrame();
        const reachedEnd = !this._loopAnimation &&
