...
import { GetGaussianSplattingMaxPartCount, GetPartIndexVaryingDeclaration } from "./gaussianSplattingMaterial.pure.js";
    ...
    return _a = class GaussianSplattingSolidColorMaterialPlugin extends _classSuper {
            ...
            _getCustomCodeGLSL(shaderType, maxPartCount) {
                if (shaderType === "vertex") {
                    return {
                        CUSTOM_VERTEX_DEFINITIONS: GetPartIndexVaryingDeclaration(0 /* ShaderLanguage.GLSL */),
...
${GetPartIndexVaryingDeclaration(0 /* ShaderLanguage.GLSL */)}
...
if (solidColorEnabled > 0.5) {
    ...
    finalColor = vec4(partColors[partIdx], finalColor.w);
            ...
            _getCustomCodeWGSL(shaderType, maxPartCount) {
                if (shaderType === "vertex") {
                    return {
                        CUSTOM_VERTEX_DEFINITIONS: GetPartIndexVaryingDeclaration(1 /* ShaderLanguage.WGSL */),
                        CUSTOM_VERTEX_UPDATE: `
#if IS_COMPOUND
    ...
    vertexOutputs.vPartIndex = 0.0;
                ...
                `,
                    ...
                    return {
                        CUSTOM_FRAGMENT_DEFINITIONS: `
${GetPartIndexVaryingDeclaration(1 /* ShaderLanguage.WGSL */)}
