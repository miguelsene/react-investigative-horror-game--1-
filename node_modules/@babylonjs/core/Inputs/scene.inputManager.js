...
export class InputManager {
    ...
    constructor(scene) {
        ...
        this._latestPointerMoveEvents = new Map();
    ...
    _updateMeshUnderPointer() {
        const scene = this._scene;
        if (!scene.constantlyUpdateMeshUnderPointer ||
    ...
    _ensurePointerMovePredicate() {
        ...
        if (!scene.pointerMovePredicate) {
            scene.pointerMovePredicate = (mesh) => (mesh._isPointerMovePickable ?? mesh.isPickable) &&
                mesh.isVisible &&
                mesh.isReady() &&
                mesh.isEnabled() &&
