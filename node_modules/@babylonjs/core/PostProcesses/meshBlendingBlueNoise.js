...
function _FillBlueNoiseChannel(data, channel, seed) {
    ...
    const rankedIndices = new Array(pixelCount);
    ...
    for (let y = 0; y < _TextureSize; y++) {
        ...
        for (let x = 0; x < _TextureSize; x++) {
            ...
            const index = y * _TextureSize + x;
            const neighborAverage = (whiteNoise[y * _TextureSize + previousX] +
 ...
 * @internal
 */
export function _GetMeshBlendBlueNoiseData() {
    if (_BlueNoiseData) {
 ...
 * @internal
 */
export function _CreateMeshBlendBlueNoiseTexture(engine) {
    const texture = new RawTexture(_GetMeshBlendBlueNoiseData(), _TextureSize, _TextureSize, 7, engine, false, false, 1, 0);
    texture.name = "MeshBlendStableBlueNoise";
    texture.wrapU = Texture.WRAP_ADDRESSMODE;
    texture.wrapV = Texture.WRAP_ADDRESSMODE;
    return texture;
}
//# sourceMappingURL=meshBlendingBlueNoise.js.map