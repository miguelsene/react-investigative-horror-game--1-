...
const name = "objectIdFunctions";
const shader = `highp vec4 encodeObjectId(highp float objectId) {
...
/** @internal */
export const objectIdFunctions = { name, shader };
//# sourceMappingURL=objectIdFunctions.js.map