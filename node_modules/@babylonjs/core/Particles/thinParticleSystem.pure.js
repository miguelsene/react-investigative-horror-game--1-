...
export class ThinParticleSystem extends BaseParticleSystem {
    ...
    _getWrapper(blendMode) {
        ...
        if (!drawWrappers) {
            ...
            if (currentRenderPassId !== 0 && !this._renderPassObserver) {
                this._renderPassObserver = ((_a = this._engine)._onReleaseRenderPassObservable ?? (_a._onReleaseRenderPassObservable = new Observable())).add((id) => {
        ...
        if (drawWrapper.defines !== join) {
            ...
            drawWrapper.setEffect(this._engine.createEffect("particles", {
    ...
    _bindGeometryRendering(effect) {
        const renderPassId = this._engine._features.supportRenderPasses ? this._engine.currentRenderPassId : 0;
