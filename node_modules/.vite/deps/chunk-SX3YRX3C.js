...
var _DefaultEventDataParseCounts = /* @__PURE__ */ new WeakMap();
function _GetDefaultEventDataParseCount(value) {
...
var FlowGraphDataConnection = class extends FlowGraphConnection {
  ...
  _reresolveDefaultValueForScene(scene) {
    ...
    } else if (typeof value.className === "string" && (value.id || value.name) && value.value === void 0) {
      reference = value;
    } else {
      return;
    }
...
export {
  ...
  FlowGraphMatrix2D,
  FlowGraphMatrix3D,
  _GetDefaultEventDataParseCount,
...
//# sourceMappingURL=chunk-SX3YRX3C.js.map
