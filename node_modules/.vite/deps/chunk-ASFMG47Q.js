...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-UWXTM2LW.js");
      } else {
        await import("./rgbdDecode.fragment-VWAATTAZ.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-2R3XNVHU.js");
    } else {
      await import("./rgbdEncode.fragment-TEMN7L2V.js");
    }
...
//# sourceMappingURL=chunk-ASFMG47Q.js.map
