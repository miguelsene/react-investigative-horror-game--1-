...
// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/fibonacci.js
var name = "fibonacci";
var shader = `fn rcp(x: f32)->f32
{return 1./x;}
...
var fibonacciWGSL = { name, shader };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/diffusionProfile.js
var name2 = "diffusionProfile";
var shader2 = `uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name2]) {
  ShaderStore.IncludesShadersStoreWGSL[name2] = shader2;
}
var diffusionProfileWGSL = { name: name2, shader: shader2 };

// node_modules/@babylonjs/core/ShadersWGSL/subSurfaceScattering.fragment.js
var name3 = "subSurfaceScatteringPixelShader";
var shader3 = `#include<helperFunctions>
#include<fibonacci>
...
var includes = [helperFunctionsWGSL, fibonacciWGSL, subSurfaceScatteringFunctionsWGSL, diffusionProfileWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var subSurfaceScatteringPixelShaderWGSL = { name: name3, shader: shader3 };
export {
  subSurfaceScatteringPixelShaderWGSL
};
//# sourceMappingURL=subSurfaceScattering.fragment-PXRIRJPC.js.map
