...
var BaseTexture = (() => {
  ...
  return _a2 = class BaseTexture extends _classSuper {
    ...
    __esDecorate(_a2, null, _get_wrapU_decorators, { kind: "getter", name: "wrapU", static: false, private: false, access: { has: (obj) => "wrapU" in obj, get: (obj) => obj.wrapU }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_wrapV_decorators, { kind: "getter", name: "wrapV", static: false, private: false, access: { has: (obj) => "wrapV" in obj, get: (obj) => obj.wrapV }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_isCube_decorators, { kind: "getter", name: "isCube", static: false, private: false, access: { has: (obj) => "isCube" in obj, get: (obj) => obj.isCube }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_is3D_decorators, { kind: "getter", name: "is3D", static: false, private: false, access: { has: (obj) => "is3D" in obj, get: (obj) => obj.is3D }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_is2DArray_decorators, { kind: "getter", name: "is2DArray", static: false, private: false, access: { has: (obj) => "is2DArray" in obj, get: (obj) => obj.is2DArray }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_gammaSpace_decorators, { kind: "getter", name: "gammaSpace", static: false, private: false, access: { has: (obj) => "gammaSpace" in obj, get: (obj) => obj.gammaSpace }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_lodGenerationOffset_decorators, { kind: "getter", name: "lodGenerationOffset", static: false, private: false, access: { has: (obj) => "lodGenerationOffset" in obj, get: (obj) => obj.lodGenerationOffset }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_lodGenerationScale_decorators, { kind: "getter", name: "lodGenerationScale", static: false, private: false, access: { has: (obj) => "lodGenerationScale" in obj, get: (obj) => obj.lodGenerationScale }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_linearSpecularLOD_decorators, { kind: "getter", name: "linearSpecularLOD", static: false, private: false, access: { has: (obj) => "linearSpecularLOD" in obj, get: (obj) => obj.linearSpecularLOD }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(_a2, null, _get_irradianceTexture_decorators, { kind: "getter", name: "irradianceTexture", static: false, private: false, access: { has: (obj) => "irradianceTexture" in obj, get: (obj) => obj.irradianceTexture }, metadata: _metadata }, null, _instanceExtraInitializers);
    ...
    __esDecorate(null, null, _displayName_decorators, { kind: "field", name: "displayName", static: false, private: false, access: { has: (obj) => "displayName" in obj, get: (obj) => obj.displayName, set: (obj, value) => {
      obj.displayName = value;
    } }, metadata: _metadata }, _displayName_initializers, _displayName_extraInitializers);
    __esDecorate(null, null, _metadata_decorators, { kind: "field", name: "metadata", static: false, private: false, access: { has: (obj) => "metadata" in obj, get: (obj) => obj.metadata, set: (obj, value) => {
      obj.metadata = value;
    } }, metadata: _metadata }, _metadata_initializers, _metadata_extraInitializers);
    __esDecorate(null, null, __hasAlpha_decorators, { kind: "field", name: "_hasAlpha", static: false, private: false, access: { has: (obj) => "_hasAlpha" in obj, get: (obj) => obj._hasAlpha, set: (obj, value) => {
      obj._hasAlpha = value;
    } }, metadata: _metadata }, __hasAlpha_initializers, __hasAlpha_extraInitializers);
    __esDecorate(null, null, __getAlphaFromRGB_decorators, { kind: "field", name: "_getAlphaFromRGB", static: false, private: false, access: { has: (obj) => "_getAlphaFromRGB" in obj, get: (obj) => obj._getAlphaFromRGB, set: (obj, value) => {
      obj._getAlphaFromRGB = value;
    } }, metadata: _metadata }, __getAlphaFromRGB_initializers, __getAlphaFromRGB_extraInitializers);
    __esDecorate(null, null, _level_decorators, { kind: "field", name: "level", static: false, private: false, access: { has: (obj) => "level" in obj, get: (obj) => obj.level, set: (obj, value) => {
      obj.level = value;
    } }, metadata: _metadata }, _level_initializers, _level_extraInitializers);
    __esDecorate(null, null, __coordinatesIndex_decorators, { kind: "field", name: "_coordinatesIndex", static: false, private: false, access: { has: (obj) => "_coordinatesIndex" in obj, get: (obj) => obj._coordinatesIndex, set: (obj, value) => {
      obj._coordinatesIndex = value;
    } }, metadata: _metadata }, __coordinatesIndex_initializers, __coordinatesIndex_extraInitializers);
    __esDecorate(null, null, _optimizeUVAllocation_decorators, { kind: "field", name: "optimizeUVAllocation", static: false, private: false, access: { has: (obj) => "optimizeUVAllocation" in obj, get: (obj) => obj.optimizeUVAllocation, set: (obj, value) => {
      obj.optimizeUVAllocation = value;
    } }, metadata: _metadata }, _optimizeUVAllocation_initializers, _optimizeUVAllocation_extraInitializers);
    __esDecorate(null, null, __coordinatesMode_decorators, { kind: "field", name: "_coordinatesMode", static: false, private: false, access: { has: (obj) => "_coordinatesMode" in obj, get: (obj) => obj._coordinatesMode, set: (obj, value) => {
      obj._coordinatesMode = value;
    } }, metadata: _metadata }, __coordinatesMode_initializers, __coordinatesMode_extraInitializers);
    __esDecorate(null, null, _wrapR_decorators, { kind: "field", name: "wrapR", static: false, private: false, access: { has: (obj) => "wrapR" in obj, get: (obj) => obj.wrapR, set: (obj, value) => {
      obj.wrapR = value;
    } }, metadata: _metadata }, _wrapR_initializers, _wrapR_extraInitializers);
    __esDecorate(null, null, _anisotropicFilteringLevel_decorators, { kind: "field", name: "anisotropicFilteringLevel", static: false, private: false, access: { has: (obj) => "anisotropicFilteringLevel" in obj, get: (obj) => obj.anisotropicFilteringLevel, set: (obj, value) => {
      obj.anisotropicFilteringLevel = value;
    } }, metadata: _metadata }, _anisotropicFilteringLevel_initializers, _anisotropicFilteringLevel_extraInitializers);
    __esDecorate(null, null, _invertZ_decorators, { kind: "field", name: "invertZ", static: false, private: false, access: { has: (obj) => "invertZ" in obj, get: (obj) => obj.invertZ, set: (obj, value) => {
      obj.invertZ = value;
    } }, metadata: _metadata }, _invertZ_initializers, _invertZ_extraInitializers);
    __esDecorate(null, null, _lodLevelInAlpha_decorators, { kind: "field", name: "lodLevelInAlpha", static: false, private: false, access: { has: (obj) => "lodLevelInAlpha" in obj, get: (obj) => obj.lodLevelInAlpha, set: (obj, value) => {
      obj.lodLevelInAlpha = value;
    } }, metadata: _metadata }, _lodLevelInAlpha_initializers, _lodLevelInAlpha_extraInitializers);
    __esDecorate(null, null, _isRenderTarget_decorators, { kind: "field", name: "isRenderTarget", static: false, private: false, access: { has: (obj) => "isRenderTarget" in obj, get: (obj) => obj.isRenderTarget, set: (obj, value) => {
      obj.isRenderTarget = value;
    } }, metadata: _metadata }, _isRenderTarget_initializers, _isRenderTarget_extraInitializers);
...
var Texture = (() => {
  ...
  return _a2 = class Texture extends _classSuper {
    /**
     * @internal
     */
    static _CreateVideoTexture(name, src, scene, generateMipMaps = false, invertY = false, samplingMode = _a2.TRILINEAR_SAMPLINGMODE, settings = {}, onError, format = 5) {
     ...
     */
    constructor(url, sceneOrEngine, noMipmapOrOptions, invertY, samplingMode = _a2.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, buffer = null, deleteBuffer = false, format, mimeType, loaderOptions, creationFlags, forcedExtension) {
      super(sceneOrEngine);
      ...
      if (typeof noMipmapOrOptions === "object" && noMipmapOrOptions !== null) {
        ...
        samplingMode = noMipmapOrOptions.samplingMode ?? _a2.TRILINEAR_SAMPLINGMODE;
      ...
      const errorHandler = (message, exception) => {
        ...
        _a2.OnTextureLoadErrorObservable.notifyObservers(this);
      };
    ...
    getReflectionTextureMatrix() {
      ...
      if (this.uOffset === this._cachedReflectionUOffset && this.vOffset === this._cachedReflectionVOffset && this.uScale === this._cachedReflectionUScale && this.vScale === this._cachedReflectionVScale && this.coordinatesMode === this._cachedReflectionCoordinatesMode) {
        if (this.coordinatesMode === _a2.PROJECTION_MODE) {
    ...
    clone() {
      ...
      return SerializationHelper.Clone(() => {
        return new _a2(this._texture ? this._texture.url : null, this.getScene(), options);
      }, this);
    }
    /**
    ...
    serialize() {
      ...
      const serializationObject = super.serialize(_a2._SerializeInternalTextureUniqueId);
      if (!serializationObject) {
        return null;
      }
      if (_a2.SerializeBuffers || _a2.ForceSerializeBuffers) {
        ...
        } else if (_a2.ForceSerializeBuffers || this.url && this.url.startsWith("blob:") || this._forceSerialize) {
      ...
      if (_a2._SerializeInternalTextureUniqueId) {
    ...
    static Parse(parsedTexture, scene, rootUrl) {
      ...
      if (parsedTexture.isCube && !parsedTexture.isRenderTarget) {
        return _a2._CubeTextureParser(parsedTexture, scene, rootUrl);
      }
      ...
      const texture = SerializationHelper.Parse(() => {
        ...
        if (parsedTexture.mirrorPlane) {
          const mirrorTexture = _a2._CreateMirror(parsedTexture.name, parsedTexture.renderTargetSize, scene, generateMipMaps);
          ...
          if (parsedTexture.isCube) {
            ...
            renderTargetTexture = _a2._CreateRenderTargetTexture(parsedTexture.name, parsedTexture.renderTargetSize, scene, generateMipMaps, parsedTexture._creationFlags ?? 0);
            renderTargetTexture._waitingRenderList = parsedTexture.renderList;
          }
          onLoaded(renderTargetTexture);
          return renderTargetTexture;
        } else if (parsedTexture.isVideo) {
          const texture2 = _a2._CreateVideoTexture(rootUrl + (parsedTexture.url || parsedTexture.name), rootUrl + (parsedTexture.src || parsedTexture.url), scene, generateMipMaps, parsedTexture.invertY, parsedTexture.samplingMode, parsedTexture.settings || {});
          onLoaded(texture2);
          return texture2;
        } else {
          let texture2;
          if (typeof parsedTexture.base64String === "string" && parsedTexture.base64String && !internalTexture) {
            ...
            texture2 = _a2.CreateFromBase64String("", noPrefixBase64String, scene, options);
            ...
            if (parsedTexture.url && (parsedTexture.url.startsWith("data:") || _a2.UseSerializedUrlIfAny)) {
            ...
            texture2 = new _a2(url, scene, options);
          }
          return texture2;
        }
      }, parsedTexture, scene);
     ...
     */
    static CreateFromBase64String(data, name, scene, noMipmapOrOptions, invertY, samplingMode = _a2.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags, forcedExtension) {
      return new _a2("data:" + name, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, data, false, format, void 0, void 0, creationFlags, forcedExtension);
    }
    /**
     ...
     * @returns the created texture
     */
    static LoadFromDataString(name, buffer, scene, deleteBuffer = false, noMipmapOrOptions, invertY = true, samplingMode = _a2.TRILINEAR_SAMPLINGMODE, onLoad = null, onError = null, format = 5, creationFlags, forcedExtension) {
      if (name.substring(0, 5) !== "data:") {
        name = "data:" + name;
      }
      return new _a2(name, scene, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, buffer, deleteBuffer, format, void 0, void 0, creationFlags, forcedExtension);
    }
  }, (() => {
    const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
    ...
    __esDecorate(_a2, null, _get_isBlocking_decorators, { kind: "getter", name: "isBlocking", static: false, private: false, access: { has: (obj) => "isBlocking" in obj, get: (obj) => obj.isBlocking }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate(null, null, _url_decorators, { kind: "field", name: "url", static: false, private: false, access: { has: (obj) => "url" in obj, get: (obj) => obj.url, set: (obj, value) => {
      obj.url = value;
    } }, metadata: _metadata }, _url_initializers, _url_extraInitializers);
    __esDecorate(null, null, _uOffset_decorators, { kind: "field", name: "uOffset", static: false, private: false, access: { has: (obj) => "uOffset" in obj, get: (obj) => obj.uOffset, set: (obj, value) => {
      obj.uOffset = value;
    } }, metadata: _metadata }, _uOffset_initializers, _uOffset_extraInitializers);
    __esDecorate(null, null, _vOffset_decorators, { kind: "field", name: "vOffset", static: false, private: false, access: { has: (obj) => "vOffset" in obj, get: (obj) => obj.vOffset, set: (obj, value) => {
      obj.vOffset = value;
    } }, metadata: _metadata }, _vOffset_initializers, _vOffset_extraInitializers);
    __esDecorate(null, null, _uScale_decorators, { kind: "field", name: "uScale", static: false, private: false, access: { has: (obj) => "uScale" in obj, get: (obj) => obj.uScale, set: (obj, value) => {
      obj.uScale = value;
    } }, metadata: _metadata }, _uScale_initializers, _uScale_extraInitializers);
    __esDecorate(null, null, _vScale_decorators, { kind: "field", name: "vScale", static: false, private: false, access: { has: (obj) => "vScale" in obj, get: (obj) => obj.vScale, set: (obj, value) => {
      obj.vScale = value;
    } }, metadata: _metadata }, _vScale_initializers, _vScale_extraInitializers);
    __esDecorate(null, null, _uAng_decorators, { kind: "field", name: "uAng", static: false, private: false, access: { has: (obj) => "uAng" in obj, get: (obj) => obj.uAng, set: (obj, value) => {
      obj.uAng = value;
    } }, metadata: _metadata }, _uAng_initializers, _uAng_extraInitializers);
    __esDecorate(null, null, _vAng_decorators, { kind: "field", name: "vAng", static: false, private: false, access: { has: (obj) => "vAng" in obj, get: (obj) => obj.vAng, set: (obj, value) => {
      obj.vAng = value;
    } }, metadata: _metadata }, _vAng_initializers, _vAng_extraInitializers);
    __esDecorate(null, null, _wAng_decorators, { kind: "field", name: "wAng", static: false, private: false, access: { has: (obj) => "wAng" in obj, get: (obj) => obj.wAng, set: (obj, value) => {
      obj.wAng = value;
    } }, metadata: _metadata }, _wAng_initializers, _wAng_extraInitializers);
    __esDecorate(null, null, _uRotationCenter_decorators, { kind: "field", name: "uRotationCenter", static: false, private: false, access: { has: (obj) => "uRotationCenter" in obj, get: (obj) => obj.uRotationCenter, set: (obj, value) => {
      obj.uRotationCenter = value;
    } }, metadata: _metadata }, _uRotationCenter_initializers, _uRotationCenter_extraInitializers);
    __esDecorate(null, null, _vRotationCenter_decorators, { kind: "field", name: "vRotationCenter", static: false, private: false, access: { has: (obj) => "vRotationCenter" in obj, get: (obj) => obj.vRotationCenter, set: (obj, value) => {
      obj.vRotationCenter = value;
    } }, metadata: _metadata }, _vRotationCenter_initializers, _vRotationCenter_extraInitializers);
    __esDecorate(null, null, _wRotationCenter_decorators, { kind: "field", name: "wRotationCenter", static: false, private: false, access: { has: (obj) => "wRotationCenter" in obj, get: (obj) => obj.wRotationCenter, set: (obj, value) => {
      obj.wRotationCenter = value;
    } }, metadata: _metadata }, _wRotationCenter_initializers, _wRotationCenter_extraInitializers);
    __esDecorate(null, null, _homogeneousRotationInUVTransform_decorators, { kind: "field", name: "homogeneousRotationInUVTransform", static: false, private: false, access: { has: (obj) => "homogeneousRotationInUVTransform" in obj, get: (obj) => obj.homogeneousRotationInUVTransform, set: (obj, value) => {
      obj.homogeneousRotationInUVTransform = value;
    } }, metadata: _metadata }, _homogeneousRotationInUVTransform_initializers, _homogeneousRotationInUVTransform_extraInitializers);
    if (_metadata) Object.defineProperty(_a2, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
  })(), /**
   * Gets or sets a general boolean used to indicate that textures containing direct data (buffers) must be saved as part of the serialization process
   */
  _a2.SerializeBuffers = true, /**
   * Gets or sets a general boolean used to indicate that texture buffers must be saved as part of the serialization process.
   * If no buffer exists, one will be created as base64 string from the internal webgl data.
   */
  _a2.ForceSerializeBuffers = false, /**
   * This observable will notify when any texture had a loading error
   */
  _a2.OnTextureLoadErrorObservable = new Observable(), /** @internal */
  _a2._SerializeInternalTextureUniqueId = false, /**
   * @internal
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  _a2._CubeTextureParser = (jsonTexture, scene, rootUrl) => {
    throw _WarnImport("CubeTexture");
  }, /**
   * @internal
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  _a2._CreateMirror = (name, renderTargetSize, scene, generateMipMaps) => {
    throw _WarnImport("MirrorTexture");
  }, /**
   * @internal
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  _a2._CreateRenderTargetTexture = (name, renderTargetSize, scene, generateMipMaps, creationFlags) => {
    throw _WarnImport("RenderTargetTexture");
  }, /** nearest is mag = nearest and min = nearest and no mip */
  _a2.NEAREST_SAMPLINGMODE = 1, /** nearest is mag = nearest and min = nearest and mip = linear */
  _a2.NEAREST_NEAREST_MIPLINEAR = 8, /** Bilinear is mag = linear and min = linear and no mip */
  _a2.BILINEAR_SAMPLINGMODE = 2, /** Bilinear is mag = linear and min = linear and mip = nearest */
  _a2.LINEAR_LINEAR_MIPNEAREST = 11, /** Trilinear is mag = linear and min = linear and mip = linear */
  _a2.TRILINEAR_SAMPLINGMODE = 3, /** Trilinear is mag = linear and min = linear and mip = linear */
  _a2.LINEAR_LINEAR_MIPLINEAR = 3, /** mag = nearest and min = nearest and mip = nearest */
  _a2.NEAREST_NEAREST_MIPNEAREST = 4, /** mag = nearest and min = linear and mip = nearest */
  _a2.NEAREST_LINEAR_MIPNEAREST = 5, /** mag = nearest and min = linear and mip = linear */
  _a2.NEAREST_LINEAR_MIPLINEAR = 6, /** mag = nearest and min = linear and mip = none */
  _a2.NEAREST_LINEAR = 7, /** mag = nearest and min = nearest and mip = none */
  _a2.NEAREST_NEAREST = 1, /** mag = linear and min = nearest and mip = nearest */
  _a2.LINEAR_NEAREST_MIPNEAREST = 9, /** mag = linear and min = nearest and mip = linear */
  _a2.LINEAR_NEAREST_MIPLINEAR = 10, /** mag = linear and min = linear and mip = none */
  _a2.LINEAR_LINEAR = 2, /** mag = linear and min = nearest and mip = none */
  _a2.LINEAR_NEAREST = 12, /** Explicit coordinates mode */
  _a2.EXPLICIT_MODE = 0, /** Spherical coordinates mode */
  _a2.SPHERICAL_MODE = 1, /** Planar coordinates mode */
  _a2.PLANAR_MODE = 2, /** Cubic coordinates mode */
  _a2.CUBIC_MODE = 3, /** Projection coordinates mode */
  _a2.PROJECTION_MODE = 4, /** Inverse Cubic coordinates mode */
  _a2.SKYBOX_MODE = 5, /** Inverse Cubic coordinates mode */
  _a2.INVCUBIC_MODE = 6, /** Equirectangular coordinates mode */
  _a2.EQUIRECTANGULAR_MODE = 7, /** Equirectangular Fixed coordinates mode */
  _a2.FIXED_EQUIRECTANGULAR_MODE = 8, /** Equirectangular Fixed Mirrored coordinates mode */
  _a2.FIXED_EQUIRECTANGULAR_MIRRORED_MODE = 9, /** Texture is not repeating outside of 0..1 UVs */
  _a2.CLAMP_ADDRESSMODE = 0, /** Texture is repeating outside of 0..1 UVs */
  _a2.WRAP_ADDRESSMODE = 1, /** Texture is repeating and mirrored */
  _a2.MIRROR_ADDRESSMODE = 2, /**
   * Gets or sets a boolean which defines if the texture url must be build from the serialized URL instead of just using the name and loading them side by side with the scene file
   */
  _a2.UseSerializedUrlIfAny = false, _a2;
})();
...
//# sourceMappingURL=chunk-JZ2Q4TKW.js.map
