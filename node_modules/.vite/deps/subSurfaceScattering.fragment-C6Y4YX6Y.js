...
var includes = [helperFunctions, fibonacci, subSurfaceScatteringFunctions, diffusionProfile];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var subSurfaceScatteringPixelShader = { name: name3, shader: shader3 };
export {
  subSurfaceScatteringPixelShader
};
//# sourceMappingURL=subSurfaceScattering.fragment-C6Y4YX6Y.js.map
