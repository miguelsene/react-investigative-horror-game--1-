...
var EffectWrapper = class _EffectWrapper {
  ...
  _postConstructor(blockCompilation, defines = null, extraInitializations, importPromises) {
    ...
    if (this.options.useShaderStore && this._shaderPath.vertex === "postprocess") {
      this._importPromises.push(useWebGPU && this._webGPUReady ? import("./postprocess.vertex-H3AHAKM5.js") : import("./postprocess.vertex-RUNGRP76.js"));
    }
...
//# sourceMappingURL=chunk-DHC2TZIH.js.map
