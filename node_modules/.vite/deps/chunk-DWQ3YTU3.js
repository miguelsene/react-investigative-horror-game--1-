...
import {
  PerfCounter
} from "./chunk-ZMLL3FDR.js";
import {
  UniformBuffer
} from "./chunk-NRK7IYYH.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-V2Z35RCG.js";
import {
  Color3,
  Color4
...
// node_modules/@babylonjs/core/Maths/colorTemperature.functions.js
...
var StandardD65Xyz = new Vector3(0.95047, 1, 1.08883);
var StandardRgbToXyzD65 = Matrix.FromArray([
  0.4124564,
  0.2126729,
  0.0193339,
  0,
...
var RgbToXyzD65 = StandardRgbToXyzD65.multiply(BradfordAdapt(StandardD65Xyz, TemperatureTintToXyz(6500, 0)));
...
var ColorCurves = (() => {
  ...
  return _a2 = class ColorCurves {
    ...
    _getColorGradingDataToRef(hue, density, saturation, exposure, result) {
      ...
      hue = _a2._Clamp(hue, 0, 360);
      density = _a2._Clamp(density, -100, 100);
      saturation = _a2._Clamp(saturation, -100, 100);
      exposure = _a2._Clamp(exposure, -100, 100);
      density = _a2._ApplyColorGradingSliderNonlinear(density);
      density *= 0.5;
      exposure = _a2._ApplyColorGradingSliderNonlinear(exposure);
      if (density < 0) {
        density *= -1;
        hue = (hue + 180) % 360;
      }
      _a2._FromHSBToRef(hue, density, 50 + 0.25 * exposure, result);
    ...
    static _FromHSBToRef(hue, saturation, brightness, result) {
      let h = _a2._Clamp(hue, 0, 360);
      const s = _a2._Clamp(saturation / 100, 0, 1);
      const v = _a2._Clamp(brightness / 100, 0, 1);
      if (s === 0) {
        result.r = v;
        result.g = v;
        result.b = v;
     ...
     */
    clone() {
      return SerializationHelper.Clone(() => new _a2(), this);
    }
    /**
    ...
    __esDecorate(null, null, __globalHue_decorators, { kind: "field", name: "_globalHue", static: false, private: false, access: { has: (obj) => "_globalHue" in obj, get: (obj) => obj._globalHue, set: (obj, value) => {
      obj._globalHue = value;
    } }, metadata: _metadata }, __globalHue_initializers, __globalHue_extraInitializers);
    __esDecorate(null, null, __globalDensity_decorators, { kind: "field", name: "_globalDensity", static: false, private: false, access: { has: (obj) => "_globalDensity" in obj, get: (obj) => obj._globalDensity, set: (obj, value) => {
      obj._globalDensity = value;
    } }, metadata: _metadata }, __globalDensity_initializers, __globalDensity_extraInitializers);
    __esDecorate(null, null, __globalSaturation_decorators, { kind: "field", name: "_globalSaturation", static: false, private: false, access: { has: (obj) => "_globalSaturation" in obj, get: (obj) => obj._globalSaturation, set: (obj, value) => {
      obj._globalSaturation = value;
    } }, metadata: _metadata }, __globalSaturation_initializers, __globalSaturation_extraInitializers);
    __esDecorate(null, null, __globalExposure_decorators, { kind: "field", name: "_globalExposure", static: false, private: false, access: { has: (obj) => "_globalExposure" in obj, get: (obj) => obj._globalExposure, set: (obj, value) => {
      obj._globalExposure = value;
    } }, metadata: _metadata }, __globalExposure_initializers, __globalExposure_extraInitializers);
    __esDecorate(null, null, __highlightsHue_decorators, { kind: "field", name: "_highlightsHue", static: false, private: false, access: { has: (obj) => "_highlightsHue" in obj, get: (obj) => obj._highlightsHue, set: (obj, value) => {
      obj._highlightsHue = value;
    } }, metadata: _metadata }, __highlightsHue_initializers, __highlightsHue_extraInitializers);
    __esDecorate(null, null, __highlightsDensity_decorators, { kind: "field", name: "_highlightsDensity", static: false, private: false, access: { has: (obj) => "_highlightsDensity" in obj, get: (obj) => obj._highlightsDensity, set: (obj, value) => {
      obj._highlightsDensity = value;
    } }, metadata: _metadata }, __highlightsDensity_initializers, __highlightsDensity_extraInitializers);
    __esDecorate(null, null, __highlightsSaturation_decorators, { kind: "field", name: "_highlightsSaturation", static: false, private: false, access: { has: (obj) => "_highlightsSaturation" in obj, get: (obj) => obj._highlightsSaturation, set: (obj, value) => {
      obj._highlightsSaturation = value;
    } }, metadata: _metadata }, __highlightsSaturation_initializers, __highlightsSaturation_extraInitializers);
    __esDecorate(null, null, __highlightsExposure_decorators, { kind: "field", name: "_highlightsExposure", static: false, private: false, access: { has: (obj) => "_highlightsExposure" in obj, get: (obj) => obj._highlightsExposure, set: (obj, value) => {
      obj._highlightsExposure = value;
    } }, metadata: _metadata }, __highlightsExposure_initializers, __highlightsExposure_extraInitializers);
    __esDecorate(null, null, __midtonesHue_decorators, { kind: "field", name: "_midtonesHue", static: false, private: false, access: { has: (obj) => "_midtonesHue" in obj, get: (obj) => obj._midtonesHue, set: (obj, value) => {
      obj._midtonesHue = value;
    } }, metadata: _metadata }, __midtonesHue_initializers, __midtonesHue_extraInitializers);
    __esDecorate(null, null, __midtonesDensity_decorators, { kind: "field", name: "_midtonesDensity", static: false, private: false, access: { has: (obj) => "_midtonesDensity" in obj, get: (obj) => obj._midtonesDensity, set: (obj, value) => {
      obj._midtonesDensity = value;
    } }, metadata: _metadata }, __midtonesDensity_initializers, __midtonesDensity_extraInitializers);
    __esDecorate(null, null, __midtonesSaturation_decorators, { kind: "field", name: "_midtonesSaturation", static: false, private: false, access: { has: (obj) => "_midtonesSaturation" in obj, get: (obj) => obj._midtonesSaturation, set: (obj, value) => {
      obj._midtonesSaturation = value;
    } }, metadata: _metadata }, __midtonesSaturation_initializers, __midtonesSaturation_extraInitializers);
    __esDecorate(null, null, __midtonesExposure_decorators, { kind: "field", name: "_midtonesExposure", static: false, private: false, access: { has: (obj) => "_midtonesExposure" in obj, get: (obj) => obj._midtonesExposure, set: (obj, value) => {
      obj._midtonesExposure = value;
    } }, metadata: _metadata }, __midtonesExposure_initializers, __midtonesExposure_extraInitializers);
   ...
   */
  _a2.PrepareUniforms = PrepareUniformsForColorCurves, _a2;
})();
...
var ImageProcessingConfiguration = (() => {
  ...
  return _a2 = class ImageProcessingConfiguration {
    constructor() {
      ...
      this._toneMappingType = (__runInitializers(this, __toneMappingEnabled_extraInitializers), __runInitializers(this, __toneMappingType_initializers, _a2.TONEMAPPING_STANDARD));
      ...
      this._vignetteBlendMode = (__runInitializers(this, _vignetteCameraFov_extraInitializers), __runInitializers(this, __vignetteBlendMode_initializers, _a2.VIGNETTEMODE_MULTIPLY));
    ...
    prepareDefines(defines, forPostProcess = false) {
      ...
      defines.VIGNETTEBLENDMODEMULTIPLY = this.vignetteBlendMode === _a2._VIGNETTEMODE_MULTIPLY;
      defines.VIGNETTEBLENDMODEOPAQUE = !defines.VIGNETTEBLENDMODEMULTIPLY;
      if (!this._toneMappingEnabled) {
        defines.TONEMAPPING = 0;
      } else {
        switch (this._toneMappingType) {
          case _a2.TONEMAPPING_KHR_PBR_NEUTRAL:
            defines.TONEMAPPING = 3;
            break;
          case _a2.TONEMAPPING_ACES:
    ...
    __esDecorate(null, null, _colorCurves_decorators, { kind: "field", name: "colorCurves", static: false, private: false, access: { has: (obj) => "colorCurves" in obj, get: (obj) => obj.colorCurves, set: (obj, value) => {
      obj.colorCurves = value;
    } }, metadata: _metadata }, _colorCurves_initializers, _colorCurves_extraInitializers);
    __esDecorate(null, null, __colorCurvesEnabled_decorators, { kind: "field", name: "_colorCurvesEnabled", static: false, private: false, access: { has: (obj) => "_colorCurvesEnabled" in obj, get: (obj) => obj._colorCurvesEnabled, set: (obj, value) => {
      obj._colorCurvesEnabled = value;
    } }, metadata: _metadata }, __colorCurvesEnabled_initializers, __colorCurvesEnabled_extraInitializers);
    __esDecorate(null, null, __colorGradingTexture_decorators, { kind: "field", name: "_colorGradingTexture", static: false, private: false, access: { has: (obj) => "_colorGradingTexture" in obj, get: (obj) => obj._colorGradingTexture, set: (obj, value) => {
      obj._colorGradingTexture = value;
    } }, metadata: _metadata }, __colorGradingTexture_initializers, __colorGradingTexture_extraInitializers);
    __esDecorate(null, null, __colorGradingEnabled_decorators, { kind: "field", name: "_colorGradingEnabled", static: false, private: false, access: { has: (obj) => "_colorGradingEnabled" in obj, get: (obj) => obj._colorGradingEnabled, set: (obj, value) => {
      obj._colorGradingEnabled = value;
    } }, metadata: _metadata }, __colorGradingEnabled_initializers, __colorGradingEnabled_extraInitializers);
    __esDecorate(null, null, __colorGradingWithGreenDepth_decorators, { kind: "field", name: "_colorGradingWithGreenDepth", static: false, private: false, access: { has: (obj) => "_colorGradingWithGreenDepth" in obj, get: (obj) => obj._colorGradingWithGreenDepth, set: (obj, value) => {
      obj._colorGradingWithGreenDepth = value;
    } }, metadata: _metadata }, __colorGradingWithGreenDepth_initializers, __colorGradingWithGreenDepth_extraInitializers);
    __esDecorate(null, null, __colorGradingBGR_decorators, { kind: "field", name: "_colorGradingBGR", static: false, private: false, access: { has: (obj) => "_colorGradingBGR" in obj, get: (obj) => obj._colorGradingBGR, set: (obj, value) => {
      obj._colorGradingBGR = value;
    } }, metadata: _metadata }, __colorGradingBGR_initializers, __colorGradingBGR_extraInitializers);
    __esDecorate(null, null, __exposure_decorators, { kind: "field", name: "_exposure", static: false, private: false, access: { has: (obj) => "_exposure" in obj, get: (obj) => obj._exposure, set: (obj, value) => {
      obj._exposure = value;
    } }, metadata: _metadata }, __exposure_initializers, __exposure_extraInitializers);
    __esDecorate(null, null, __toneMappingEnabled_decorators, { kind: "field", name: "_toneMappingEnabled", static: false, private: false, access: { has: (obj) => "_toneMappingEnabled" in obj, get: (obj) => obj._toneMappingEnabled, set: (obj, value) => {
      obj._toneMappingEnabled = value;
    } }, metadata: _metadata }, __toneMappingEnabled_initializers, __toneMappingEnabled_extraInitializers);
    __esDecorate(null, null, __toneMappingType_decorators, { kind: "field", name: "_toneMappingType", static: false, private: false, access: { has: (obj) => "_toneMappingType" in obj, get: (obj) => obj._toneMappingType, set: (obj, value) => {
      obj._toneMappingType = value;
    } }, metadata: _metadata }, __toneMappingType_initializers, __toneMappingType_extraInitializers);
    __esDecorate(null, null, __contrast_decorators, { kind: "field", name: "_contrast", static: false, private: false, access: { has: (obj) => "_contrast" in obj, get: (obj) => obj._contrast, set: (obj, value) => {
      obj._contrast = value;
    } }, metadata: _metadata }, __contrast_initializers, __contrast_extraInitializers);
    __esDecorate(null, null, __whiteBalanceEnabled_decorators, { kind: "field", name: "_whiteBalanceEnabled", static: false, private: false, access: { has: (obj) => "_whiteBalanceEnabled" in obj, get: (obj) => obj._whiteBalanceEnabled, set: (obj, value) => {
      obj._whiteBalanceEnabled = value;
    } }, metadata: _metadata }, __whiteBalanceEnabled_initializers, __whiteBalanceEnabled_extraInitializers);
    __esDecorate(null, null, __temperature_decorators, { kind: "field", name: "_temperature", static: false, private: false, access: { has: (obj) => "_temperature" in obj, get: (obj) => obj._temperature, set: (obj, value) => {
      obj._temperature = value;
    } }, metadata: _metadata }, __temperature_initializers, __temperature_extraInitializers);
    __esDecorate(null, null, __tint_decorators, { kind: "field", name: "_tint", static: false, private: false, access: { has: (obj) => "_tint" in obj, get: (obj) => obj._tint, set: (obj, value) => {
      obj._tint = value;
    } }, metadata: _metadata }, __tint_initializers, __tint_extraInitializers);
    __esDecorate(null, null, _vignetteStretch_decorators, { kind: "field", name: "vignetteStretch", static: false, private: false, access: { has: (obj) => "vignetteStretch" in obj, get: (obj) => obj.vignetteStretch, set: (obj, value) => {
      obj.vignetteStretch = value;
    } }, metadata: _metadata }, _vignetteStretch_initializers, _vignetteStretch_extraInitializers);
    __esDecorate(null, null, _vignetteCenterX_decorators, { kind: "field", name: "vignetteCenterX", static: false, private: false, access: { has: (obj) => "vignetteCenterX" in obj, get: (obj) => obj.vignetteCenterX, set: (obj, value) => {
      obj.vignetteCenterX = value;
    } }, metadata: _metadata }, _vignetteCenterX_initializers, _vignetteCenterX_extraInitializers);
    __esDecorate(null, null, _vignetteCenterY_decorators, { kind: "field", name: "vignetteCenterY", static: false, private: false, access: { has: (obj) => "vignetteCenterY" in obj, get: (obj) => obj.vignetteCenterY, set: (obj, value) => {
      obj.vignetteCenterY = value;
    } }, metadata: _metadata }, _vignetteCenterY_initializers, _vignetteCenterY_extraInitializers);
    __esDecorate(null, null, _vignetteWeight_decorators, { kind: "field", name: "vignetteWeight", static: false, private: false, access: { has: (obj) => "vignetteWeight" in obj, get: (obj) => obj.vignetteWeight, set: (obj, value) => {
      obj.vignetteWeight = value;
    } }, metadata: _metadata }, _vignetteWeight_initializers, _vignetteWeight_extraInitializers);
    __esDecorate(null, null, _vignetteColor_decorators, { kind: "field", name: "vignetteColor", static: false, private: false, access: { has: (obj) => "vignetteColor" in obj, get: (obj) => obj.vignetteColor, set: (obj, value) => {
      obj.vignetteColor = value;
    } }, metadata: _metadata }, _vignetteColor_initializers, _vignetteColor_extraInitializers);
    __esDecorate(null, null, _vignetteCameraFov_decorators, { kind: "field", name: "vignetteCameraFov", static: false, private: false, access: { has: (obj) => "vignetteCameraFov" in obj, get: (obj) => obj.vignetteCameraFov, set: (obj, value) => {
      obj.vignetteCameraFov = value;
    } }, metadata: _metadata }, _vignetteCameraFov_initializers, _vignetteCameraFov_extraInitializers);
    __esDecorate(null, null, __vignetteBlendMode_decorators, { kind: "field", name: "_vignetteBlendMode", static: false, private: false, access: { has: (obj) => "_vignetteBlendMode" in obj, get: (obj) => obj._vignetteBlendMode, set: (obj, value) => {
      obj._vignetteBlendMode = value;
    } }, metadata: _metadata }, __vignetteBlendMode_initializers, __vignetteBlendMode_extraInitializers);
    __esDecorate(null, null, __vignetteEnabled_decorators, { kind: "field", name: "_vignetteEnabled", static: false, private: false, access: { has: (obj) => "_vignetteEnabled" in obj, get: (obj) => obj._vignetteEnabled, set: (obj, value) => {
      obj._vignetteEnabled = value;
    } }, metadata: _metadata }, __vignetteEnabled_initializers, __vignetteEnabled_extraInitializers);
    __esDecorate(null, null, __ditheringEnabled_decorators, { kind: "field", name: "_ditheringEnabled", static: false, private: false, access: { has: (obj) => "_ditheringEnabled" in obj, get: (obj) => obj._ditheringEnabled, set: (obj, value) => {
      obj._ditheringEnabled = value;
    } }, metadata: _metadata }, __ditheringEnabled_initializers, __ditheringEnabled_extraInitializers);
    __esDecorate(null, null, __ditheringIntensity_decorators, { kind: "field", name: "_ditheringIntensity", static: false, private: false, access: { has: (obj) => "_ditheringIntensity" in obj, get: (obj) => obj._ditheringIntensity, set: (obj, value) => {
      obj._ditheringIntensity = value;
    } }, metadata: _metadata }, __ditheringIntensity_initializers, __ditheringIntensity_extraInitializers);
    __esDecorate(null, null, __skipFinalColorClamp_decorators, { kind: "field", name: "_skipFinalColorClamp", static: false, private: false, access: { has: (obj) => "_skipFinalColorClamp" in obj, get: (obj) => obj._skipFinalColorClamp, set: (obj, value) => {
      obj._skipFinalColorClamp = value;
    } }, metadata: _metadata }, __skipFinalColorClamp_initializers, __skipFinalColorClamp_extraInitializers);
    __esDecorate(null, null, __applyByPostProcess_decorators, { kind: "field", name: "_applyByPostProcess", static: false, private: false, access: { has: (obj) => "_applyByPostProcess" in obj, get: (obj) => obj._applyByPostProcess, set: (obj, value) => {
      obj._applyByPostProcess = value;
    } }, metadata: _metadata }, __applyByPostProcess_initializers, __applyByPostProcess_extraInitializers);
    __esDecorate(null, null, __isEnabled_decorators, { kind: "field", name: "_isEnabled", static: false, private: false, access: { has: (obj) => "_isEnabled" in obj, get: (obj) => obj._isEnabled, set: (obj, value) => {
      obj._isEnabled = value;
    } }, metadata: _metadata }, __isEnabled_initializers, __isEnabled_extraInitializers);
    __esDecorate(null, null, _outputTextureWidth_decorators, { kind: "field", name: "outputTextureWidth", static: false, private: false, access: { has: (obj) => "outputTextureWidth" in obj, get: (obj) => obj.outputTextureWidth, set: (obj, value) => {
      obj.outputTextureWidth = value;
    } }, metadata: _metadata }, _outputTextureWidth_initializers, _outputTextureWidth_extraInitializers);
    __esDecorate(null, null, _outputTextureHeight_decorators, { kind: "field", name: "outputTextureHeight", static: false, private: false, access: { has: (obj) => "outputTextureHeight" in obj, get: (obj) => obj.outputTextureHeight, set: (obj, value) => {
      obj.outputTextureHeight = value;
    } }, metadata: _metadata }, _outputTextureHeight_initializers, _outputTextureHeight_extraInitializers);
    if (_metadata) Object.defineProperty(_a2, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
  })(), /**
   * Default tone mapping applied in BabylonJS.
   */
  _a2.TONEMAPPING_STANDARD = 0, /**
   * ACES Tone mapping (used by default in unreal and unity). This can help getting closer
   * to other engines rendering to increase portability.
   */
  _a2.TONEMAPPING_ACES = 1, /**
   * Neutral Tone mapping developped by the Khronos group in order to constrain
   * values between 0 and 1 without shifting Hue.
   */
  _a2.TONEMAPPING_KHR_PBR_NEUTRAL = 2, /**
   * Prepare the list of uniforms associated with the Image Processing effects.
   * @param uniforms The list of uniforms used in the effect
   * @param defines the list of defines currently in use
   */
  _a2.PrepareUniforms = PrepareUniformsForImageProcessing, /**
   * Prepare the list of samplers associated with the Image Processing effects.
   * @param samplersList The list of uniforms used in the effect
   * @param defines the list of defines currently in use
   */
  _a2.PrepareSamplers = PrepareSamplersForImageProcessing, // Static constants associated to the image processing.
  _a2._VIGNETTEMODE_MULTIPLY = 0, _a2._VIGNETTEMODE_OPAQUE = 1, _a2;
})();
...
var WebDeviceInputSystem = class {
  ...
  _getGamepadDeviceType(deviceName) {
    ...
    } else if (deviceName.indexOf("Xbox One") !== -1 || deviceName.search("Xbox 360") !== -1 || deviceName.search("xinput") !== -1 || // Microsoft vendor id covers Xbox Series/One/Elite controllers reported with various names
...
var InputManager = class _InputManager {
  ...
  constructor(scene) {
    ...
    this._latestPointerMoveEvents = /* @__PURE__ */ new Map();
  ...
  /** @internal */
  _updateMeshUnderPointer() {
    const scene = this._scene;
    if (!scene.constantlyUpdateMeshUnderPointer || this._latestPointerMoveEvents.size === 0 || scene.skipPointerMovePicking || !scene.cameraToUseForPointers && !scene.activeCamera) {
      return;
    }
  ...
  _ensurePointerMovePredicate() {
    const scene = this._scene;
    if (!scene.pointerMovePredicate) {
      scene.pointerMovePredicate = (mesh) => (mesh._isPointerMovePickable ?? mesh.isPickable) && mesh.isVisible && mesh.isReady() && mesh.isEnabled() && (mesh.enablePointerMoveEvents || scene.constantlyUpdateMeshUnderPointer || mesh._getActionManagerForTrigger() !== null) && (!scene.cameraToUseForPointers || (scene.cameraToUseForPointers.layerMask & mesh.layerMask) !== 0);
    }
  }
  ...
  attachControl(attachUp = true, attachDown = true, attachMove = true, elementToAttachTo = null) {
    ...
    this._onPointerMove = (evt) => {
      ...
      this._latestPointerMoveEvents.set(evt.pointerId, {
        event: evt,
...
var Scene = class _Scene {
  ...
  constructor(engine, options) {
    ...
    this._animationWrites = new Array();
  ...
  async _loadDelayedFileAsync(url, useArrayBuffer, useOfflineSupport) {
    if (!this._delayedFileRequests) {
      this._delayedFileRequests = /* @__PURE__ */ new Map();
    }
...
//# sourceMappingURL=chunk-DWQ3YTU3.js.map
