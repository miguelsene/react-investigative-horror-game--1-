...
var ComputeShader = (() => {
  ...
  return _a = class ComputeShader {
    ...
    setUniformBuffer(name, buffer) {
      ...
      this._bindings[name] = {
        type: _a._BufferIsDataBuffer(buffer) ? 7 : 2,
        object: buffer,
        indexInGroupEntries: current?.indexInGroupEntries
      };
    }
    ...
    setStorageBuffer(name, buffer) {
      ...
      this._contextIsDirty || (this._contextIsDirty = !current || current.object !== buffer);
      this._bindings[name] = {
        type: _a._BufferIsDataBuffer(buffer) ? 7 : 3,
        object: buffer,
        indexInGroupEntries: current?.indexInGroupEntries
      };
    }
    ...
    __esDecorate(null, null, _fastMode_decorators, { kind: "field", name: "fastMode", static: false, private: false, access: { has: (obj) => "fastMode" in obj, get: (obj) => obj.fastMode, set: (obj, value) => {
      obj.fastMode = value;
    } }, metadata: _metadata }, _fastMode_initializers, _fastMode_extraInitializers);
...
//# sourceMappingURL=chunk-AYJ6KXYR.js.map
