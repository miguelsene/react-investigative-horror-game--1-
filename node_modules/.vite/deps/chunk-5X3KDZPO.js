...
var pbrHelperFunctions = { name: name2, shader: shader2 };
...
var pbrDirectLightingSetupFunctions = { name: name3, shader: shader3 };
...
var shader4 = `float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
var pbrDirectLightingFalloffFunctions = { name: name4, shader: shader4 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrDirectLightingFunctions.js
var name5 = "pbrDirectLightingFunctions";
var shader5 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
var pbrDirectLightingFunctions = { name: name5, shader: shader5 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockNormalGeometric.js
var name6 = "pbrBlockNormalGeometric";
var shader6 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var pbrBlockNormalGeometric = { name: name6, shader: shader6 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockImageProcessing.js
var name7 = "pbrBlockImageProcessing";
var shader7 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var pbrBlockImageProcessing = { name: name7, shader: shader7 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrDebug.js
var name8 = "pbrDebug";
var shader8 = `#if DEBUGMODE>0
...
var pbrDebug = { name: name8, shader: shader8 };
...
//# sourceMappingURL=chunk-5X3KDZPO.js.map
