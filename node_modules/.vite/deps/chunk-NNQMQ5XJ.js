...
uniform inverseEmitterWM: mat4x4f;uniform geometryWorldOffset: vec3f;
#endif
...
var cornerPos: vec2f;var vPositionW: vec3f;
#ifdef PREPASS
...
rotatedCorner.x=cornerPos.x*cos(vertexInputs.angle)-cornerPos.y*sin(vertexInputs.angle)+uniforms.translationPivot.x;rotatedCorner.y=cornerPos.x*sin(vertexInputs.angle)+cornerPos.y*cos(vertexInputs.angle)+uniforms.translationPivot.y;rotatedCorner.z=0.;var toCamera: vec3f=vertexInputs.position-uniforms.eyePosition;vPositionW=rotateAlign(toCamera,rotatedCorner);
#ifdef PREPASS
...
//# sourceMappingURL=chunk-NNQMQ5XJ.js.map
