...
// node_modules/@babylonjs/core/Misc/halfFloat.js
var Tables = null;
...
var LoadImage = (input, onLoad, onError, offlineProvider, mimeType = "", imageBitmapOptions, engine = EngineStore.LastCreatedEngine) => {
  ...
  if (engine?._features.forceBitmapOverHTMLImageElement && typeof input !== "string" && typeof Blob !== "undefined") {
    ...
    engine.createImageBitmap(blob, { premultiplyAlpha: "none", colorSpaceConversion: "none", ...imageBitmapOptions }).then(onLoad).catch((reason) => {
      if (onError) {
...
//# sourceMappingURL=chunk-J4HIGVMO.js.map
