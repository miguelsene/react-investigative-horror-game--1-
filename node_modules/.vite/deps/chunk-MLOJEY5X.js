...
var decalVertexDeclaration = { name, shader };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/uvAttributeDeclaration.js
var name2 = "uvAttributeDeclaration";
var shader2 = `#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;
...
var uvAttributeDeclaration = { name: name2, shader: shader2 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/prePassVertexDeclaration.js
var name3 = "prePassVertexDeclaration";
...
var prePassVertexDeclaration = { name: name3, shader: shader3 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/samplerVertexDeclaration.js
var name4 = "samplerVertexDeclaration";
var shader4 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
var samplerVertexDeclaration = { name: name4, shader: shader4 };
...
var prePassVertex = { name: name5, shader: shader5 };
...
var uvVariableDeclaration = { name: name6, shader: shader6 };
...
var samplerVertexImplementation = { name: name7, shader: shader7 };
...
//# sourceMappingURL=chunk-MLOJEY5X.js.map
