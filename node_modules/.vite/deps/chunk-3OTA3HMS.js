...
function IsIntegerTextureFormat(format) {
  return format === 8 || format === 9 || format === 10 || format === 11;
}
function IsUnsignedIntegerTextureType(type) {
  return type === 0 || type === 5 || type === 7 || type === 11;
}
...
var ThinEngine = class _ThinEngine extends AbstractEngine {
  ...
  clear(color, backBuffer, depth, stencil = false, stencilClearValue = 0) {
    ...
    if (backBuffer && color) {
      ...
      if (this._currentRenderTarget) {
        ...
        if (textureFormat !== void 0 && IsIntegerTextureFormat(textureFormat)) {
          const textureType = this._currentRenderTarget.texture?.type;
          if (textureType !== void 0 && IsUnsignedIntegerTextureType(textureType)) {
   ...
   * @internal
   */
  _clearColorAttachment(attachmentIndex, color, format, type) {
    if (IsIntegerTextureFormat(format)) {
      const unsigned = IsUnsignedIntegerTextureType(type);
      const values = unsigned ? _ThinEngine._TempClearColorUint32 : _ThinEngine._TempClearColorInt32;
      values[0] = color.r;
      values[1] = color.g;
      values[2] = color.b;
      values[3] = color.a;
      if (unsigned) {
        this._gl.clearBufferuiv(this._gl.COLOR, attachmentIndex, values);
      } else {
        this._gl.clearBufferiv(this._gl.COLOR, attachmentIndex, values);
      }
      return;
    }
    _ThinEngine._TempClearColorFloat32[0] = color.r;
    _ThinEngine._TempClearColorFloat32[1] = color.g;
    _ThinEngine._TempClearColorFloat32[2] = color.b;
    _ThinEngine._TempClearColorFloat32[3] = color.a;
    this._gl.clearBufferfv(this._gl.COLOR, attachmentIndex, _ThinEngine._TempClearColorFloat32);
  }
  /**
   * @internal
   */
  ...
  applyStates() {
    ...
    this._alphaState.apply(this._gl, this._currentRenderTarget && this._currentRenderTarget.textures ? this._currentRenderTarget.textures.length : 1, this._integerMRTAttachmentsMask);
...
ThinEngine._TempClearColorFloat32 = new Float32Array(4);
...
//# sourceMappingURL=chunk-3OTA3HMS.js.map
