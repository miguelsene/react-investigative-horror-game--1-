...
var UniformBuffer = class _UniformBuffer {
  ...
  _resetOwnerSlots() {
    ...
    this._ownerListsBySlot = /* @__PURE__ */ new Map();
    this._slotByOwner = /* @__PURE__ */ new WeakMap();
    this._slotFrameId = [];
    this._ownerCount = 0;
    this._freeSlots = [];
   ...
   */
  _takeFreeSlot(takeOwnership) {
    for (let i = 0; i < this._freeSlots.length; ++i) {
      const idx2 = this._freeSlots[i];
      if (this._slotFrameId[idx2] !== this._currentFrameId) {
        if (takeOwnership) {
...
//# sourceMappingURL=chunk-NRK7IYYH.js.map
